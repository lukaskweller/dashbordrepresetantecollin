const CACHE='collin-dashboard-4-1-manus-plus-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./service-worker.js','./data/clientes.json','./assets/icon.svg'];
